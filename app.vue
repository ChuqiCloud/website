    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
        ...
        <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:py-4">
              ...
              <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full start-0 min-w-60 bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-neutral-800 dark:divide-neutral-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5">
                <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div class="flex flex-col mx-1 md:mx-0">
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Explore advice and explanations for all of Preline's features.</p>
                      </div>
                    </a>
                    ...
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Discover the huge range of tools that Preline integrates with.</p>
                      </div>
                    </a>
                    ...
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Build custom integrations with our first-class API.</p>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="flex flex-col mx-1 md:mx-0">
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Learn how to install, set up, and use Preline.</p>
                      </div>
                    </a>
                    ...
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Learn how to integrate or build on top of Preline.</p>
                      </div>
                    </a>
                    ...
                    <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10" href="#">
                      ...
                      <div class="grow">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">Learn, share, and connect with other Preline users.</p>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                    ...
                    <!-- Link -->
                    <a class="group mt-2 p-3 flex gap-x-5 items-center rounded-xl hover:bg-gray-100 dark:hover:bg-neutral-500/10" href="#">
