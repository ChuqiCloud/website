<template>
  <NuxtLayout>
    ...
    <div>
      ...
      <!-- ========== HEADER ========== -->
      <header
        class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7"
      >
        <nav
        ...
        >
          <div class="md:col-span-3">
            ...
            >
              <img
                class="h-8"
                src="https://bbs.acmecloud.cn/data/attachment/common/template/boardimg_20240115efehkfwk.png"
                alt="Acmecloud"
              />
            </a>
            <!-- End Logo -->
