    ...
    <div>
      ...
      <div class="bg-gradient-to-r from-red-500 via-purple-400 to-blue-500">
        <div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 mx-auto">
          <!-- Grid -->
          <div
            class="grid justify-center md:grid-cols-2 md:justify-between md:items-center gap-2"
          >
            ...
            <div
              class="mt-3 text-center md:text-start md:flex md:justify-end md:items-center"
            >
              <a
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div class="mt-5 max-w-3xl text-center mx-auto">
            <p class="text-lg text-gray-600 dark:text-neutral-400">
              AcmeCloud 系一个优秀的软件服务提供商，拥有 5 年 IDC
              经验，汇聚前沿，云启未来，极致云厚积薄发，愿与千百厂商推动技术革新，赋能上云
            </p>
          </div>
          ...
          <div class="mt-8 gap-3 flex justify-center">
            <a
              class="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-full py-3 px-4 dark:focus:ring-offset-gray-800"
              href="#"
            >
              即刻开始
              <svg
          ...
          <div class="lg:col-span-4">
            ...
            <div class="lg:pe-6 xl:pe-12">
              <p class="text-6xl font-bold leading-10 text-blue-600">
                92%
                <span
                  class="ms-1 inline-flex items-center gap-x-1 bg-gray-200 font-medium text-gray-800 text-xs leading-4 rounded-full py-0.5 px-2 dark:bg-neutral-800 dark:text-neutral-300"
                >
                  <svg
                    class="flex-shrink-0 size-4"
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="grid md:grid-cols-5 gap-10">
          <div class="md:col-span-2">
            <div class="max-w-xs">
              ...
              <p
                class="mt-1 hidden md:block text-gray-600 dark:text-neutral-400"
              >
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="sm:w-1/2 xl:w-1/3 mx-auto text-center mb-6 md:mb-12">
          <h2
            class="text-xl font-semibold md:text-2xl md:leading-tight text-gray-800 dark:text-neutral-200"
          >
        ...
        <!-- Grid -->
        <div
          class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3 lg:gap-6"
        >
          <div class="p-4 md:p-7 bg-gray-100 rounded-lg dark:bg-neutral-800">
            <svg
              class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto text-gray-800 dark:text-neutral-200"
          ...
          <div class="p-4 md:p-7 bg-gray-100 rounded-lg dark:bg-neutral-800">
            <svg
              class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto"
              fill="none"
